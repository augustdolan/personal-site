...
const Navbar = () => {
  return (
    <nav className="py-4 px-3 sm:px-32 fixed w-full bg-emerald-950 z-10">
      <ol className="flex flex-row flex-wrap gap-2 sm:gap-4 justify-center sm:justify-end items-center">
